...
<div class="container">
    <div class="panel panel-primary" align="center"
        ...
        <div class="panel-body">
            <s:form action="login!login" method="POST" cssStyle="align-content: center">
                <s:actionmessage cssClass="alert alert-danger dismissible fade show"/>
                <s:textfield name="account" type="number" cssClass="form-control" label="账号"
                             placeholder="请输入学号或职工号！" required="true" requiredLabel="*" requiredPosition="right"/>
                <s:password name="password" autocomplete="on" data-toggle="password" cssClass="form-control" label="密码"
