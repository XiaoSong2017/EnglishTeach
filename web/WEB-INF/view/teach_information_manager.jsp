...
<body>
<div class="nav nav-justified float-left flex-column nav-pills" id="v-pills-tab" role="tablist"
...
<div class="tab-content align-content-stretch float-right" id="v-pills-tabContent" style="width: 85%">
